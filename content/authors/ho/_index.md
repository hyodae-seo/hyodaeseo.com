...
social:
  - icon: envelope
    icon_pack: fas
    link: 'mailto:???r@hawaii.edu'
  #- icon: twitter
  #  icon_pack: fab
  #  link: https://x.com/hyodae
  - icon: google-scholar
    icon_pack: ai
    link: https://scholar.google.com/citations?user=4ipfQgoAAAAJ&hl=en
  - icon: github
    icon_pack: fab
    link: 
  - icon: orcid
    icon_pack: fab
    link: https://orcid.org/0000-0001-9768-6456
  - icon: earth-americas
    icon_pack: fas
    link: 
