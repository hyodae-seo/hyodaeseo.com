...
<style>
.article-style { font-size: 0.8rem; line-height: 1.55; }
.article-container > h1 { font-size: 1.05rem; font-weight: 700; line-height: 1.3; }
.article-style > h2,
.project-personnel h2 { font-size: 0.95rem; font-weight: 700; margin: 1.4rem 0 0.65rem; }
.project-lead { font-size: 0.84rem; line-height: 1.6; max-width: 920px; }
.project-goals { margin-bottom: 1.25rem; padding-left: 1.15rem; }
.project-goals li { margin-bottom: 0.45rem; }
.project-result { border: 1px solid #d9e1e6; border-radius: 0.4rem; margin: 1rem 0 1.35rem; padding: 0.9rem; }
.project-result h3 { font-size: 0.9rem; font-weight: 700; margin: 0 0 0.5rem; }
...
.personnel-grid { align-items: flex-start; display: flex !important; flex-flow: row nowrap !important; gap: 1rem; max-width: none; width: 100%; }
.personnel-card { flex: 0 0 120px !important; margin: 0 !important; min-width: 120px; text-align: center; width: 120px !important; }
.personnel-card img { border-radius: 50%; display: block; height: 96px !important; margin: 0 auto; max-width: none; object-fit: cover; width: 96px !important; }
.personnel-card.agency-card img { border-radius: 0.3rem; object-fit: contain; }
.personnel-card figcaption { font-size: 0.75rem; line-height: 1.3; margin-top: 0.35rem; }
body.dark .project-result { border-color: #46535d; }
body.dark .result-figure figcaption { color: #b7c1c9; }
@media (max-width: 700px) {
  .result-grid { grid-template-columns: 1fr; }
}
@media (max-width: 520px) {
  .personnel-grid { gap: 0.25rem; }
  .personnel-card { flex-basis: 72px !important; min-width: 72px; width: 72px !important; }
  .personnel-card img { height: 64px !important; width: 64px !important; }
...
<section class="project-personnel" aria-labelledby="project-personnel-heading">
  ...
  <div class="personnel-grid">
    ...
    <figure class="personnel-card">
      <a href="/author/wyn-pauly/"><img src="/author/wyn-pauly/avatar.jpg" alt="Wyn Pauly"></a>
...
<section class="project-result">
  ...
  <figure class="result-figure field-photo">
	...
	<figcaption>One of the drifting Spotter buoys beached on Tonaki Island approximately 20 m from the waterline following the Typhoon Saudel deployment. Its transmitted trajectory and wave records captured conditions primarily on the left side of the storm before the buoy reached shore. Photo: Dr. Tunggul Bhirawa (OIST)
	</figcaption>
